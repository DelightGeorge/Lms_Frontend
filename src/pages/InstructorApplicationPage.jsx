...
import {
  ...
  BookOpen, User, Clock, Award, Info, X, File,
} from "lucide-react";
...
// ── Upload utility — uses "auto" so Cloudinary detects type itself ─────────
...
export default function InstructorApplicationPage() {
  ...
  useEffect(() => {
    ...
    API.get("/instructor-applications/my")
      .then((r) => { if (r.data) setExisting(r.data); })
      .catch(() => {});
  }, [user]);
          ...
          {existing.status === "APPROVED" ? (
            ...
            <>
              ...
              <p className="text-xs text-slate-400">
                Submitted {new Date(existing.createdAt).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}
              </p>
            </>
          ) : (
            <>
              ...
              {existing.rejectionReason && (
                <p className="text-slate-600 mb-2 text-sm bg-red-50 rounded-xl p-3">"{existing.rejectionReason}"</p>
              )}
      ...
      <div className="min-h-screen flex items-center justify-center pt-20 px-4">
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-12 text-center max-w-lg w-full">
          ...
          <p className="text-slate-400 text-sm mb-8">
            You'll receive an email notification at <strong>{user.email}</strong> once a decision is made.
          </p>
  ...
  return (
    <Layout>
      {toast && (
        <div className={`fixed top-6 right-6 z-[999] px-5 py-3.5 rounded-xl text-white font-bold shadow-2xl text-sm ${
          ...
          <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 space-y-6">
            ...
            {step === 1 && (
              <>
                ...
                <div className="space-y-4">
                  ...
                  <Textarea
                    label="Professional Bio" required
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <input
                        type="url"
                        value={form.portfolioUrl && !form.portfolioUrl.startsWith("https://res.cloudinary") ? form.portfolioUrl : ""}
                      ...
                      <FileUpload
                        label="" hint="PDF, images, or any document · Max 10MB"
                        accept=".pdf,.jpg,.jpeg,.png,.zip,.doc,.docx"
                        icon={FileText}
                        value={form.portfolioUrl?.startsWith("https://res.cloudinary") ? form.portfolioUrl : ""}
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-2">
                    ...
                    <p className="text-xs text-blue-700 leading-relaxed">
                      We recommend instructors have at least 2 years of professional experience in their field to ensure quality content for our learners.
                    </p>
                  </div>
                </div>
              </>
                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-2">
                    ...
                    <p className="text-xs text-amber-700 leading-relaxed">
                      All documents are securely stored and only used to verify your identity. They are never shared publicly or with third parties.
                    </p>
                  </div>
                </div>
              </>
            ...
            {step === 4 && (
              <>
                ...
                <div className="space-y-4">
                  <Textarea
                    label="Why do you want to teach on LMSPRO?" required
                    ...
                    {[
                      ...
                      <div key={label} className="flex justify-between text-xs">
                        ...
                        <span className={`font-bold ${
                          val.includes("✓") ? "text-emerald-600" :
                          val === "—"       ? "text-red-400"     : "text-slate-700"
                        }`}>{val}</span>
                      </div>
                    ))}
                  </div>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button
                ...
                disabled={!canProceed() || loading || uploadingId || uploadingCv || uploadingVideo || uploadingPortfolio}
