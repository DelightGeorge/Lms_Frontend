...
import {
  ...
  TrendingUp, Shield, ChevronRight, Loader2,
  Trash2, Eye, Menu, X, LayoutDashboard,
...
const TABS = ["Overview", "Pending Courses", "All Users"];
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      {/* Toast */}
      {toast && (
        <div className={`fixed top-4 right-4 z-50 px-5 py-3 rounded-xl text-white font-bold shadow-lg transition-all
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-slate-50 border-b border-slate-100">
                        ...
                        <th className="text-left px-5 py-3 text-xs font-bold text-slate-500 uppercase tracking-wider">Verified</th>
